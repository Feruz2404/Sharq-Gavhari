export default {
  ...
  admin: {
    ...
    previewHint: 'Logo, background, name, and accent color update here in real time.',
    ...
    backgroundPlaceholder: 'Drop the background image here or click the button',
    logoHelper: 'JPG, PNG or WEBP \u2014 up to 5MB. The logo appears in the menu header.',
    backgroundHelper: 'JPG, PNG or WEBP \u2014 up to 5MB. The image is used as the customer menu hero/background.',
    tables: 'Tables',
    logout: 'Logout',
    isActive: 'Active',
