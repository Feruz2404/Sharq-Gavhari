...
export default function CategoryCard({ category, basePath = '/category' }) {
  ...
  return (
    <motion.div whileHover={hover} whileTap={tap} transition={cardTransition}>
      <Link
        to={`${basePath}/${slug}`}
        className="group glass block overflow-hidden relative ring-1 ring-transparent hover:ring-gold/30 hover:shadow-[0_18px_40px_-18px_rgba(212,175,55,0.45)] transition-shadow"
      >
